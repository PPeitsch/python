...
-> Ejercicio 1.10: Calculadora de Adelantos - Tablas

Modicá tu programa para que imprima una tabla mostrando el mes,
...
print('Ejercicio: 1.10: Calculadora de Adelantos - Tablas\n')
