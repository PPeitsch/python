...
Modified on Wed Sep 14 16:27:48 2022
...
print('Ejercicio 3.3: Diccionarios como contenedores.\n')
...
fruta = input('\nIngrese la fruta a buscar: ')

try:
    for a in range(len(precios)):
        precio = precios[fruta]
    print(f'El precio de {fruta} es: $AR {precio}')
except KeyError:
...
Ingrese la fruta a buscar: Zanahoria
El precio de Zanahoria es: $AR 49.74
