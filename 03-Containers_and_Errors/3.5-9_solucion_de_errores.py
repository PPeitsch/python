...
Modified on Wed Sep 14 16:42:48 2022
...
# la letra para mostrar que funciona correctamente. En estos casos, que no
# se necesita distinción de mayúscula y minúscula es más fácil utilizar algo como:
...
print('\nAutor: Pablo Reynoso Peitsch')
print('Materia: Programación I')
print('Ejercicio 3.9: Pisando memoria.\n')
